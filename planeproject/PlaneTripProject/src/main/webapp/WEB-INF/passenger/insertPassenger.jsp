...
<style>
    ...
    #personnal_data{width: 1000px; height: 50px; display: inline-block; }
...
<script>
	$(document).ready(function(){
        ...
        for(let i = 1; i <= personnal_num; i++){
            ...
            personnal_data += "<input type='hidden' name='gender" + i + "' id='gender" + i + "' value='남성'>"
            personnal_data += "<p class='name_f_p'>성(영문)</p><input type='text' name='name_f" + i + "' class='name_f'>"
            personnal_data += "<p class='name_p'>이름(영문)</p><input type='text' name='name" + i + "' class='name'>"
            personnal_data += "<p class='ph_p'>연락처</p><input type='text' name='ph" + i + "' class='ph'>"
            personnal_data += "<p class='birthday_p'>생년월일(YYYYMMDD)</p><input type='text' name='birthday" + i + "' class='birthday'>"
